...
namespace AtanaCompanyWeb.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ShippersController(TEST_DOOContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Shippers != null ? 
                          ...
                          Problem("Entity set 'TEST_DOOContext.Shippers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TEST_DOOContext.Shippers'  is null.");
            }
            var shipper = await _context.Shippers.FindAsync(id);
            if (shipper != null)
            {
