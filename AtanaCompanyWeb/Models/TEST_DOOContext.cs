...
{
    public partial class TEST_DOOContext : DbContext
    {
        public TEST_DOOContext()
        {
        }

        public TEST_DOOContext(DbContextOptions<TEST_DOOContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<EmpOrder> EmpOrders { get; set; } = null!;
